...
public class Question5 extends AppCompatActivity implements Question {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionText = findViewById(R.id.radioQuestionText);
        answer1 = findViewById(R.id.radioAnswer1);
        answer2 = findViewById(R.id.radioAnswer2);
        answer3 = findViewById(R.id.radioAnswer3);
        answer4 = findViewById(R.id.radioAnswer4);
        buttonNext = findViewById(R.id.radioNext);
        back = findViewById(R.id.backQuestion5);
        ...
        buttonNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (alreadyAnswer) {
                    ...
                    Intent intent = new Intent(view.getContext(), Question6.class);
    ...
    public void updateAnswer(){
        ...
        if(quizData.getActualPageQuestion() < quizData.getCurrentQuestion()){
            List<Integer> reponse = quizData.getQuizAnswer(5);

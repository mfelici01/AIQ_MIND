...
public class Question6 extends AppCompatActivity implements Question{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionText = findViewById(R.id.inputQuestionText);
        answer = findViewById(R.id.inputAnswer);
        soluce = findViewById(R.id.inputSoluce);
        buttonNext = findViewById(R.id.inputNext);
        back = findViewById(R.id.backQuestion6);
        alreadyAnswer = false;
        ...
        buttonNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (alreadyAnswer) {
                    ...
                    Log.d("size", "tab size before next: " + quizData.getQuizSize());


                    Intent intent = new Intent(view.getContext(), Question7.class);
    ...
    public void updateAnswer(){
        Log.d("size", "actual page : " + quizData.getActualPageQuestion());
        Log.d("size", "current question : " + quizData.getCurrentQuestion());
        Log.d("size", "tab size before updateAnswer: " + quizData.getQuizSize());
        if(quizData.getActualPageQuestion() < quizData.getCurrentQuestion()){
            List<Integer> reponse = quizData.getQuizAnswer(6);
    ...
    public void colorChoice() {
        ...
        if (TextUtils.isEmpty(answer.getText().toString())) {
            soluce.setText(getResources().getString(R.string.question6R1));
            soluce.setBackgroundColor(green);
        } else if (answer.getText().toString().equals(getResources().getString(R.string.question6R1))) {
    ...
    public void updateScore() {
        if (!TextUtils.isEmpty(answer.getText().toString()) &&
                answer.getText().toString().equals(getResources().getString(R.string.question6R1))) {
